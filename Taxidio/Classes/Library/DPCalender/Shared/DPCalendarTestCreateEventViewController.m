...
- (void)viewDidLoad
{
    ...
    self.event = [[DPCalendarEvent alloc] initWithTitle:@"Holiday" startTime:[[NSDate date] dateByAddingYears:0 months:0 days:-1] endTime:[[NSDate date] dateByAddingYears:0 months:0 days:1] colorIndex:0 setID:@""];
