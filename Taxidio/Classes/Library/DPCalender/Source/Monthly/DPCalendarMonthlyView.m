...
static NSInteger const DPCalendarDefaultTitleLabelFontSize = 8;
...
@property (nonatomic) NSInteger startDayOfWeek;
...
- (void) applyCustomDefaults
{
    ...
    if (attributes[DPCalendarMonthlyViewAttributeMonthRows]) {
        ...
        self.cellHeight = (300 - self.weekdayHeight) / rows;
    } else {
        self.cellHeight = 300;//[attributes[DPCalendarMonthlyViewAttributeCellHeight] floatValue] ?: DPCalendarMonthlyViewAttributeCellHeightDefault;
    }
    ...
    self.eventFont = attributes[DPCalendarMonthlyViewAttributeEventFont] ?: [UIFont systemFontOfSize:DPCalendarDefaultTitleLabelFontSize];
    ...
    self.eventDrawingStyle = (int)[attributes[DPCalendarMonthlyViewAttributeEventDrawingStyle]integerValue] ?: DPCalendarMonthlyViewEventDrawingStyleBar;
...
- (NSDate *)firstVisibleDateOfMonth:(NSDate *)date {
    ...
    int daysInWeek = (int)self.daysInWeek;
...
- (NSDate *)lastVisibleDateOfMonth:(NSDate *)date {
    ...
    int daysRemain = (int)(daysInWeek + self.startDayOfWeek - 1) - ((components.weekday - 1) % daysInWeek);
...
- (NSArray *)defaultEventColors {
    return @[[UIColor colorWithRed:0/255.f green:136/255.0f blue:47/255.0f alpha:1],
             [UIColor colorWithRed:89/255.f green:25/255.0f blue:134/255.0f alpha:1],
             [UIColor colorWithRed:255/255.f green:100/255.0f blue:32/255.0f alpha:1]];
}
...
- (UIColor*) defaultSeparatorColor {
    ...
    return [UIColor blackColor];//[UIColor colorWithRed:194/255.0f green:194/255.0f blue:202/255.0f alpha:1];
}
...
- (UIColor*) defaultDayTextColor {
    ...
    return [UIColor blackColor];//colorWithRed:156/255.0f green:156/255.0f blue:156/255.0f alpha:1];
}
